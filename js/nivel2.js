...
let comidasFavoritas=['carne','pollo','papas'];
...
comidasFavoritas.push('sancocho')
//console.log(comidasFavoritas)
...
/*
function calcularPromedio(notasPacial){
    var sumaNota=0;
    for(i=0;i<notasPacial.length;i++){
        sumaNota=sumaNota+notasPacial[i];
    }
    console.log("El promedio del semestre es: " + sumaNota/notasPacial.length);
}

var notasPacial = [4,4,5,5];
calcularPromedio(notasPacial);
*/

// TAREA; Calcular el promedio que tome como parametro un array
/*
