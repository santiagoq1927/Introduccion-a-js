...
alert("Mi nombre es: " + nombre + " Mi edad es: " + edad);
*/
...
function calcularSalarioMensual(salarioAnual){
    ...
    let salarioMensual = salarioAnual/numeroMeses
    return(salarioMensual)
}

function calcularSalarioAnual(salarioMensual){
    const numeroMeses = 12;
    let salarioAnual = salarioMensual*numeroMeses
    return(salarioAnual)
}

let salarioAnual = Number(prompt("Ingresa Salario Anual"))
let salarioMensual = Number(prompt("Ingresa Salario Mensual"))
console.log("Su salario mensual es: " +calcularSalarioMensual(salarioAnual) + " Millones de pesos")
console.log("Su salario anual es: " +calcularSalarioAnual(salarioMensual) + " Millones de pesos")
*/
/*
...
let anioNac=Number(prompt("Ingrese año de nacimiento:"));
let mesNac=Number(prompt("Ingrese mes de nacimiento:"));
console.log(calcularMesesVividos(anioNac,mesNac));*/
...
function seleccionarOperacion(opcion){
    var valor;
    if(opcion=="+"){
        var numero1 = Number(prompt("Ingrese primer numero"))
        var numero2 = Number(prompt("Ingrese segundo numero"))
        return valor=sumar(numero1,numero2)
    }else if(opcion=="-"){
        var numero3 = Number(prompt("Ingrese primer numero"))
        var numero4 = Number(prompt("Ingrese segundo numero"))
        return valor = restar(numero3,numero4)
    }else if(opcion=="*"){
        var numero5 = Number(prompt("Ingrese primer numero"))
        var numero6 = Number(prompt("Ingrese segundo numero"))
        return valor=multiplicar(numero5,numero6)
    }else if(opcion=="/"){
        var numero7 = Number(prompt("Ingrese primer numero"))
        var numero8 = Number(prompt("Ingrese segundo numero"))
        return valor=dividir(numero7,numero8)
    }else{
        console.log("Operacion no valida")
    }
}
var opcion = prompt("Ingrese + para sumar - Ingrese - para restar - Ingrese * para multiplicar - Ingrese / para dividir")
console.log(`el resultado de la operacion es: ${seleccionarOperacion(opcion)}`);
...
// TAREA: usando el operador !, Intentá invertir una variable //
//(de true a false, o de false a true) e imprimí el
// resultado en la consola.

 let rojocapo = true;
 let verdecagon=true;
 let verdecampeon=true;

 console.log(`rojo ${rojocapo} verdecagon ${verdecagon} verdecampeon ${!verdecampeon}`)
////////////////////////////////////////////////////////////////////////////
