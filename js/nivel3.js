...
function obtenerUnaEtiqueta(){
    const nuestroTitulo = document.querySelector('h1');
    console.log(nuestroTitulo);
    nuestroTitulo.innerText="Hola /&Colombian"
    console.log(nuestroTitulo);
}
...
function seleccionarVarios(){
    ...
    for(let i=0;i<mediaLinks.length;i++){
        mediaLinks[i].innerText='Hola, aguanta America'
...
function ponerNodo(){
    ...
    imagenNodo.src = 'img/woman_bw.jpg';
    document.querySelector('header').appendChild(imagenNodo);
}
...
$botonIngreso.onclick = function(e){
    ...
    let resultado;
    if(edadUsuario>=18){
        resultado= "Benvenido al bar del diablo";
    }else{
        resultado='Prohibido el ingreso menor'
    }
